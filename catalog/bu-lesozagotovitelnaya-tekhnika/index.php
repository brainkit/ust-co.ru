...
$arFilter = Array("IBLOCK_ID"=>"176",  "ACTIVE"=>"Y", "CODE"=>$pieces[4]);
...
<div class="bu-page"> <?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"SEF_MODE" => "Y",
		"SEF_FOLDER" => "/catalog/bu-lesozagotovitelnaya-tekhnika/",
		"AJAX_MODE" => "N",
		"AJAX_OPTION_JUMP" => "N",
		"AJAX_OPTION_STYLE" => "Y",
		...
		"GENERAL_PROPERTIES_LIST" => array("PHOTO","LOT","YEAR_OF_RELEASE","MTBF","LOCATION","CONTACTS","ENABLE_DETAILED_PAGE","DESCRIPTION_DETAIL
...
?> <?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"COMPLEX_COMPONENT_PATH" => "/catalog/bu-lesozagotovitelnaya-tekhnika/",
