...
//echo "</pre>";?>
<?//unset($_POST);?>
<div class="kombox-filter grokhoty-mobilnye" id="kombox-filter">
    <form name="<?echo $arParams["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get"<?if($arResult['IS_SEF']):?> data-sef="yes"<?endif;?>>
        ...
        <?if($arItem["PROPERTY_TYPE"] == "N" || isset($arItem["PRICE"])):?>
            ...
            <li class="lvl1<?if($arItem["CLOSED"]):?> closed<?endif;?> select_right <?echo $arItem["CODE_ALT"]?> <?echo $arItem["CODE_ALT"]?>" data-id="<?echo $arItem["CODE_ALT"].'-'.$arItem["ID"]?>">
            ...
            <li class="lvl1<?if($arItem["CLOSED"]):?> closed<?endif;?> select_right <?echo $arItem["CODE_ALT"]?>" data-id="<?echo $arItem["CODE_ALT"].'-'.$arItem["ID"]?>">
                <div class="kombox-filter-property-head kombox-middle" style="width: 147px; padding: 1.8em 10px 5px 5px;">
                    <?if(strlen($arItem['HINT'])):?>
                    <span class="kombox-filter-property-hint"></span>
                    <div class="kombox-filter-property-hint-text"><?echo $arItem['HINT']?></div>
        ...
        <li class="lvl1<?if($arItem["CLOSED"]):?> closed<?endif;?> privod <?echo $arItem["CODE_ALT"]?>" data-id="<?echo $arItem["CODE_ALT"].'-'.$arItem["ID"]?>">
        ...
        <?elseif(!empty($arItem["VALUES"]) && !isset($arItem["PRICE"])):?>
            <li class="lvl1<?if($arItem["CLOSED"]):?> closed<?endif;?> <?if($element_conter%2):?>select_right<?else:?>select_left<?endif?> <?echo $arItem["CODE_ALT"]?>" data-id="<?echo $arItem["CODE_ALT"].'-'.$arItem["ID"]?>"<?if($arItem["CODE_ALT"] == "brand"):?>style="width:490px;"<?endif;?>>
                <div class="kombox-filter-property-head" style="padding: 1.8em 35px 5px 5px;">
                    <?if(strlen($arItem['HINT'])):?>
                    <span class="kombox-filter-property-hint"></span>
                    <div class="kombox-filter-property-hint-text"><?echo $arItem['HINT']?></div>
                    <?endif;?>
