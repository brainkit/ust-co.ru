        ...
        <li class="lvl1<?if($arResult["ITEMS"]["1212"]["CLOSED"]):?> closed<?endif;?> privod" data-id="<?echo $arResult["ITEMS"]["1212"]["CODE_ALT"].'-'.$arResult["ITEMS"]["1212"]["ID"]?>">
                ...
                <div class="kombox-combo" data-name="<?=$arResult["ITEMS"]["1212"]["CODE_ALT"]?>" style="float:right; width:600px; padding: 0;">                
                    <ul>
                        ...
                        <?
                        // seo code end
                        if ($arResult["ITEMS"]["1212"]["CODE_ALT"]=="pto_tip_privoda") {
...
if (!empty($arr_filter_ispoln) and count($arr_filter_ispoln)>1) {
   ...
   foreach ($arr_filter_ispoln as $item_filter) {
      echo '<a href="http://ust-co.ru/catalog/mnogokhodovye-pogruzchiki/filter/pto_tip_privoda-'.$item_filter["key"].'/">многоходовый погрузчик '.(mb_strtolower($item_filter["val"])).'</a>';
