...
*/?>
    <form name="<?echo $arParams["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get"<?if($arResult['IS_SEF']):?> data-sef="yes"<?endif;?>>
        ...
        <li class="lvl1 select_left">
                ...
                <div id="vil_type_naves" style="padding: 5px 0 0 0px; float: left;">
        ...
        <li class="lvl1 select_right" data-id="<?echo $arResult["ITEMS"]["212"]["CODE_ALT"].'-'.$arResult["ITEMS"]["212"]["ID"]?>">
                <div class="kombox-filter-property-head" style="padding: 1.8em 5px 5px 5px; width: 60px;">
