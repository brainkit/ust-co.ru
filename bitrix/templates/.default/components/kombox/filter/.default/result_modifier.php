...
<?
    ...
    while ($arSectionFiltered = $rsc2->GetNext(false, false))
           {   
    ...
    while ($arSect = $rcs->GetNext(false, false))
       {   
    ...
    if ($arParentSection = $rsParentSection1->GetNext(false, false))
    {
       ...
       while ($arSect4 = $rsSect4->GetNext(false, false))
       {
...
if(count($arResult["preview_section_filtered"]) > 0){
    ...
    if ($arParentSection = $rsParentSection->GetNext(false, false))
    {   
       ...
       $rsSect3 = CIBlockSection::GetList(array('left_margin' => 'asc'),$arFilter3);
       while ($arSect3 = $rsSect3->GetNext(false, false))
       {
    ...
    while ($arSect4 = $result2->GetNext(false, false))
           {   
