    ...
    <form name="<?echo $arParams["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get"<?if($arResult['IS_SEF']):?> data-sef="yes"<?endif;?>>
        ...
        <li class="lvl1 select_left" data-id="<?echo $arResult["ITEMS"]["212"]["CODE_ALT"].'-'.$arResult["ITEMS"]["212"]["ID"]?>">
                ...
                <div id="brand_holder" style="padding: 5px 0 0 15px;">
                    ...
                    <!-- <ul> -->
                        <?foreach($arResult["ITEMS"]["212"]["VALUES"] as $val => $ar):?>
                        <!-- <li class="<?echo $ar["DISABLED"]? 'kombox-disabled ': ''?><?echo $ar["CHECKED"]? 'kombox-checked': ''?>">                                -->
                            <option class="kombox_option" <?/*for="<?=$ar["CONTROL_ID"]?>"*/?> label="<?=$ar["CONTROL_ID"]?>" style="width: 324px;" id="<?=$ar["CONTROL_NAME_ALT"];?>" value="<?=$ar["VALUE"];?>"><?=$ar["VALUE"];?></option>
                        <!-- </li> -->
                        <?endforeach;?>
                    <!-- </ul> -->
                    </select>
        ...
        <?if($arResult["ITEMS"]["832"]["PROPERTY_TYPE"] == "N" || isset($arResult["ITEMS"]["832"]["PRICE"])):?>
            ...
            <li class="lvl1<?if($arResult["ITEMS"]["832"]["CLOSED"]):?> closed<?endif;?> select_right" data-id="<?echo $arResult["ITEMS"]["832"]["CODE_ALT"].'-'.$arResult["ITEMS"]["832"]["ID"]?>">
                ...
                <div class="solo_brand"><?=(int)$arResult["ITEMS"]["832"]["VALUES"]["MIN"]["VALUE"];?></div>
            </li> 
            <?else:?>
            <li class="lvl1<?if($arResult["ITEMS"]["832"]["CLOSED"]):?> closed<?endif;?> select_right" data-id="<?echo $arResult["ITEMS"]["832"]["CODE_ALT"].'-'.$arResult["ITEMS"]["832"]["ID"]?>">
                <div class="kombox-filter-property-head kombox-middle">
                ...
                <?foreach($arResult["ITEMS"]["832"]["VALUES"] as $val => $ar):?>    
       ...
       <?if(($arResult["ITEMS"]["1350"]["CODE_ALT"] == "tip_mashiny") && (!empty($arResult["ITEMS"]["1350"]["VALUES"]))):?>
            <li style="padding-top: 13px;" class="<?if($arResult["ITEMS"]["1350"]["CLOSED"]):?> closed<?endif;?> lvl1 select_right " data-id="<?echo $arResult["ITEMS"]["1350"]["CODE_ALT"].'-'.$arResult["ITEMS"]["1350"]["ID"]?>">
                ...
                <div class="kombox-combo" data-name="<?=$arResult["ITEMS"]["1350"]["CODE_ALT"]?>" style="float:right;  padding: 0;">                
                    <ul>
                        ...
                        <li class="li_checkbox <?echo $ar["DISABLED"]? 'kombox-disabled ': ''?><?echo $ar["CHECKED"]? 'kombox-checked': ''?>">                               
                            ...
                            <label for="<?=$ar["CONTROL_ID"]?>" class="label_checked checkbox_off" style="padding-right:9px;"><div style="padding-top: 8px;padding-left: 20px"><?echo $ar["VALUE"];?></div> <span style="padding-top: 8px; display: none;">(<?echo $arResult["section_filter"]["CNT"];?>)</span></label>
                            <?else:?>
                            <label for="<?=$ar["CONTROL_ID"]?>" class="label_checked checkbox_off" style="padding-right:9px;"><div style="padding-top: 8px;padding-left: 20px"><?echo $ar["VALUE"];?></div> <span style="padding-top: 8px; display: none;">(<?echo $ar["CNT"];?>)</span></label>
                            <?endif?>
                        </li>
                        <?endforeach;?>
                    </ul> 
