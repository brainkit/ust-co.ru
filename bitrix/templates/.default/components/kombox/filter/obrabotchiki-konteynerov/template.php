...
*/?>
    <form name="<?echo $arParams["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get"<?if($arResult['IS_SEF']):?> data-sef="yes"<?endif;?>>
        ...
        <?endif?>        
        <?if($arResult["ITEMS"]["1178"]["PROPERTY_TYPE"] == "N" || isset($arResult["ITEMS"]["1178"]["PRICE"])):?>
            <?if(isset($arResult["ITEMS"]["1178"]["VALUES"]["MIN"]["VALUE"]) && isset($arResult["ITEMS"]["1178"]["VALUES"]["MAX"]["VALUE"]) && $arResult["ITEMS"]["1178"]["VALUES"]["MAX"]["VALUE"] > $arResult["ITEMS"]["1178"]["VALUES"]["MIN"]["VALUE"]):?>
            <li class="lvl1<?if($arResult["ITEMS"]["1178"]["CLOSED"]):?> closed<?endif;?> select_right" data-id="<?echo $arResult["ITEMS"]["1178"]["CODE_ALT"].'-'.$arResult["ITEMS"]["1178"]["ID"]?>">
                <div class="kombox-filter-property-head kombox-middle" style="width: 147px; padding: 1.8em 10px 5px 5px;">
                    <?if(strlen($arResult["ITEMS"]["1178"]['HINT'])):?>
                    <span class="kombox-filter-property-hint"></span>
                    <div class="kombox-filter-property-hint-text"><?echo $arResult["ITEMS"]["1178"]['HINT']?></div>
                    <?endif;?>
                    <span class="kombox-filter-property-name"><?echo $arResult["ITEMS"]["1178"]["NAME"]?>:</span>   
                </div>
                <div class="kombox-num" data-name="<?=$arResult["ITEMS"]["1178"]["CODE_ALT"]?>">
                    <table style="width: 100%;">
                        <tr>
                            <?
                            $minValue = !empty($arResult["ITEMS"]["1178"]["VALUES"]["MIN"]["HTML_VALUE"]) ? $arResult["ITEMS"]["1178"]["VALUES"]["MIN"]["HTML_VALUE"] : $arResult["ITEMS"]["1178"]["VALUES"]["MIN"]["VALUE"];
                            $maxValue = !empty($arResult["ITEMS"]["1178"]["VALUES"]["MAX"]["HTML_VALUE"]) ? $arResult["ITEMS"]["1178"]["VALUES"]["MAX"]["HTML_VALUE"] : $arResult["ITEMS"]["1178"]["VALUES"]["MAX"]["VALUE"];
                            ?>
                            <td class="kombox-from" style="display: none;">
                                ...
                                <input 
                                    ...
                                    type="text" 
                                    name="<?echo $arResult["ITEMS"]["1178"]["VALUES"]["MIN"]["CONTROL_NAME"]?>" 
                                    id="<?echo $arResult["ITEMS"]["1178"]["VALUES"]["MIN"]["CONTROL_ID"]?>" 
                                    value="<?echo $arResult["ITEMS"]["1178"]["VALUES"]["MIN"]["HTML_VALUE"]?>" 
                                    size="5" 
                                />
                            </td>
                            <td class="kombox-range"> 
                                <div  
                                    ...
                                    data-min="<?echo $arResult["ITEMS"]["1178"]["VALUES"]["MIN"]["VALUE"]?>" 
                                    data-max="<?echo $arResult["ITEMS"]["1178"]["VALUES"]["MAX"]["VALUE"]?>" 
                                    data-range-from="<?echo $arResult["ITEMS"]["1178"]["VALUES"]["MIN"]["RANGE_VALUE"]?>" 
                                    data-range-to="<?echo $arResult["ITEMS"]["1178"]["VALUES"]["MAX"]["RANGE_VALUE"]?>" 
                                >
                                </div>
                            </td>
                            <td class="kombox-to" style="display: none">
                                ...
                                <input 
                                    ...
                                    type="text" 
                                    name="<?echo $arResult["ITEMS"]["1178"]["VALUES"]["MAX"]["CONTROL_NAME"]?>" 
                                    id="<?echo $arResult["ITEMS"]["1178"]["VALUES"]["MAX"]["CONTROL_ID"]?>" 
                                    value="<?echo $arResult["ITEMS"]["1178"]["VALUES"]["MAX"]["HTML_VALUE"]?>" 
                                    size="5" 
                                />
                                 <?=$arResult["ITEMS"]["1178"]['UNITS']?>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <?elseif(count($arResult["ITEMS"]["1178"]["VALUES"]) > 1):?>
            <li class="lvl1<?if($arResult["ITEMS"]["1178"]["CLOSED"]):?> closed<?endif;?> select_right" data-id="<?echo $arResult["ITEMS"]["1178"]["CODE_ALT"].'-'.$arResult["ITEMS"]["1178"]["ID"]?>">
                ...
                <div class="solo_brand"><?=(int)$arResult["ITEMS"]["1178"]["VALUES"]["MIN"]["VALUE"];?></div>
            </li> 
            <?else:?>
            <li class="lvl1<?if($arResult["ITEMS"]["1178"]["CLOSED"]):?> closed<?endif;?> select_right" data-id="<?echo $arResult["ITEMS"]["1178"]["CODE_ALT"].'-'.$arResult["ITEMS"]["1178"]["ID"]?>">
                <div class="kombox-filter-property-head kombox-middle">
                ...
                <?foreach($arResult["ITEMS"]["1178"]["VALUES"] as $val => $ar):?>    
            ...
            <?endif;?>
        <?endif;?>
  <?if($arResult["ITEMS"]["832"]["PROPERTY_TYPE"] == "N" || isset($arResult["ITEMS"]["832"]["PRICE"])):?>
            <?if(isset($arResult["ITEMS"]["832"]["VALUES"]["MIN"]["VALUE"]) && isset($arResult["ITEMS"]["832"]["VALUES"]["MAX"]["VALUE"]) && $arResult["ITEMS"]["832"]["VALUES"]["MAX"]["VALUE"] > $arResult["ITEMS"]["832"]["VALUES"]["MIN"]["VALUE"]):?>
            <li class="lvl1<?if($arResult["ITEMS"]["832"]["CLOSED"]):?> closed<?endif;?> select_right" data-id="<?echo $arResult["ITEMS"]["832"]["CODE_ALT"].'-'.$arResult["ITEMS"]["832"]["ID"]?>">
                <div class="kombox-filter-property-head kombox-middle" style="width: 147px; padding: 1.8em 10px 5px 5px;">
                    <?if(strlen($arResult["ITEMS"]["832"]['HINT'])):?>
                    <span class="kombox-filter-property-hint"></span>
                    <div class="kombox-filter-property-hint-text"><?echo $arResult["ITEMS"]["832"]['HINT']?></div>
                    <?endif;?>
                    <span class="kombox-filter-property-name"><?echo $arResult["ITEMS"]["832"]["NAME"]?>:</span>   
                </div>
                <div class="kombox-num" data-name="<?=$arResult["ITEMS"]["832"]["CODE_ALT"]?>">
                    <table style="width: 100%;">
                        <tr>
                            <?
                            $minValue = !empty($arResult["ITEMS"]["832"]["VALUES"]["MIN"]["HTML_VALUE"]) ? $arResult["ITEMS"]["832"]["VALUES"]["MIN"]["HTML_VALUE"] : $arResult["ITEMS"]["832"]["VALUES"]["MIN"]["VALUE"];
                            $maxValue = !empty($arResult["ITEMS"]["832"]["VALUES"]["MAX"]["HTML_VALUE"]) ? $arResult["ITEMS"]["832"]["VALUES"]["MAX"]["HTML_VALUE"] : $arResult["ITEMS"]["832"]["VALUES"]["MAX"]["VALUE"];
                            ?>
                            <td class="kombox-from" style="display: none;">
                                <?echo GetMessage("KOMBOX_CMP_FILTER_FROM")?> 
                                <input 
                                    class="kombox-input kombox-num-from" 
                                    type="text" 
                                    name="<?echo $arResult["ITEMS"]["832"]["VALUES"]["MIN"]["CONTROL_NAME"]?>" 
                                    id="<?echo $arResult["ITEMS"]["832"]["VALUES"]["MIN"]["CONTROL_ID"]?>" 
                                    value="<?echo $arResult["ITEMS"]["832"]["VALUES"]["MIN"]["HTML_VALUE"]?>" 
                                    size="5" 
                                />
                            </td>
                            <td class="kombox-range"> 
                                <div  
                                    data-value="<?echo $minValue?>;<?=$maxValue?>" 
                                    data-min="<?echo $arResult["ITEMS"]["832"]["VALUES"]["MIN"]["VALUE"]?>" 
                                    data-max="<?echo $arResult["ITEMS"]["832"]["VALUES"]["MAX"]["VALUE"]?>" 
                                    data-range-from="<?echo $arResult["ITEMS"]["832"]["VALUES"]["MIN"]["RANGE_VALUE"]?>" 
                                    data-range-to="<?echo $arResult["ITEMS"]["832"]["VALUES"]["MAX"]["RANGE_VALUE"]?>" 
                                >
                                </div>
                            </td>
                            <td class="kombox-to" style="display: none">
                                ...
                                <input 
                                    class="kombox-input kombox-num-to" 
                                    type="text" 
                                    name="<?echo $arResult["ITEMS"]["832"]["VALUES"]["MAX"]["CONTROL_NAME"]?>" 
                                    id="<?echo $arResult["ITEMS"]["832"]["VALUES"]["MAX"]["CONTROL_ID"]?>" 
                                    value="<?echo $arResult["ITEMS"]["832"]["VALUES"]["MAX"]["HTML_VALUE"]?>" 
                                    size="5" 
                                />
                                 <?=$arResult["ITEMS"]["832"]['UNITS']?>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <?elseif(count($arResult["ITEMS"]["832"]["VALUES"]) > 1):?>
