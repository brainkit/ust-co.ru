...
*/?>
    <form name="<?echo $arParams["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get"<?if($arResult['IS_SEF']):?> data-sef="yes"<?endif;?>>
        ...
        <li class="lvl1 select_left" data-id="<?echo $arResult["ITEMS"]["998"]["CODE_ALT"].'-'.$arResult["ITEMS"]["998"]["ID"]?>">
                <div class="kombox-filter-property-head" style="padding: 1.8em 10px 5px 5px;">
                    <span class="kombox-filter-property-name"><?=$arResult["ITEMS"]["998"]["NAME"]?>:</span>
                </div>        
                <div style="float: left; padding: 5px 0px 0px;">
...
<?if($arResult["ITEMS"]["212"]):?>
        <li class="lvl1 select_left" data-id="<?echo $arResult["ITEMS"]["212"]["CODE_ALT"].'-'.$arResult["ITEMS"]["212"]["ID"]?>">
                ...
                <div style="padding: 5px 0px 0px; float: left;">
