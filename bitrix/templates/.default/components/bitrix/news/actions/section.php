...
<div class="subscribe-plate">
    ...
    <?if($arParams["USE_RSS"]=="Y"):?>
        ...
        <div class="rss"><a href="<?=$rss_url?>" title="rss" target="_blank"></a></div>
    <?endif;?>
...
<div class="actions-page">
    <?if($arParams["USE_FILTER"]=="Y"):?>
        <?$APPLICATION->IncludeComponent("areal:actions.filter", ".default", array("SECTION_CODE" => $arResult["VARIABLES"]["SECTION_CODE"]));?>
    <?endif?>
