...
<?//global $USER;
 ...
 //if (($USER->GetID() == 10 )|| ($USER->GetID() == 8))
 //{
    $arFilter = array('CODE' => $arResult["VARIABLES"]["SECTION_CODE"], 'IBLOCK_ID' => 54, 'IBLOCK_TYPE' => 'used');
    $arGroupBy = false;
...
<?if($arResult["VARIABLES"]["SECTION_CODE"] || $arResult["VARIABLES"]["SECTION_ID"]):?>
    ...
    <div class="catalog-information-left-col">
        ...
        if($SECTION_ID > 0):
            global $faq_filter;
            $faq_filter = array("PROPERTY_USED_CATALOG_SKLAD" => $SECTION_ID);
            $APPLICATION->IncludeComponent(
                "bitrix:news.list",
                "faq",
                Array(
    ...
    <?if($SECTION_ID > 0):?>
        <?$APPLICATION->IncludeComponent("areal:video.catalog", ".default", array("IBLOCK_ID" => VIDEO, "FILTER" => array("PROPERTY_USED_CATALOG_SKLAD" => $SECTION_ID)));?>
    <?endif;?>
    <div class="clear"></div>
<?endif;?>
