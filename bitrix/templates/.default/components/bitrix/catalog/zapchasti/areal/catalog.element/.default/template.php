...
<div class="catalog-detail catalog <? if ($naves)
{
    echo 'naves';
...
<div class="useful_hrefs">Смотрите также: 
		<a href="<?=$arResult["SECTION"]["SECTION_PAGE_URL"]?>">все <?=strtolower($arResult["SECTION"]["NAME"])?></a>,
	<?if (!$is_two_brands):?>
		<?if ($rus_brandname!=''){?>
		<a href="<?echo $arResult["SECTION"]["SECTION_PAGE_URL"].'filter/brand-'.$trans_brand_name;?>"><?echo strtolower($arResult["SECTION"]["NAME"]).' '.$brand_name.'('.$rus_brandname.')';?></a>,
			<?}else{?><a href="<?echo $arResult["SECTION"]["SECTION_PAGE_URL"].'filter/brand-'.$trans_brand_name;?>"><?echo strtolower($arResult["SECTION"]["NAME"]).' '.$brand_name;?></a>,<?}?>
	<?endif;?>
	<?if ($show_in_href == "Y"):?>
		<?
		...
		?>
		<?if ($rus_brandname!=''){?><a href="<?echo $fisrt_level_href.'filter/brand-'.$trans_brand_name;?>">вся техника <?=$brand_name.'('.$rus_brandname.')';?></a>,<?}else{?><a href="<?echo $fisrt_level_href.'filter/brand-'.$trans_brand_name;?>">вся техника <?=$brand_name;?></a>,<?}?>
	<?endif;?>
		<a href="<?echo '/partnery/'.$brand_code.'/'?>">информация о бренде <?=$brand_name?></a>
</div>
