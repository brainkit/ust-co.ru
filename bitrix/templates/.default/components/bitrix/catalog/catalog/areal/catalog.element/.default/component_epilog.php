        ...
        if ($look["ID"] != $arResult["ITEMS"][0]["ID"]) {
            ...
            $looked_items[] = array(
                ...
                "PREVIEW_PICTURE" => CFile::ResizeImageGet(
                        $look["PREVIEW_PICTURE"], array("width" => 119, "height" => 100), BX_RESIZE_IMAGE_PROPORTIONAL, true
                )
            );
        }
    }
...
<? endif; ?>
        ...
        <? if($_SERVER["REQUEST_URI"]=="/catalog/navesnoe-oborudovanie-dlya-skladskoy-tekhniki/vily-dlya-pogruzchikov/"):
        ?>
        <script type="text/javascript">
            $(document).ready(function () {
                 $(".tabs-detail #ui-id-3").click();
