...
<table id="shapka-letter" width="801" height="470" border="0" cellpadding="0" cellspacing="0" style="margin:0 auto;">
	...
	<tr>
		...
		<td colspan="4" style="font-family:Verdana; font-size:13px; color:#000000;">
			Доброе утро,</td>
		<td colspan="5" style="font-family:Verdana; font-size:9px; color:#000000; height:15px;">
			11.11.2014 г.</td>
		<td>
	...
	<tr>
		<td colspan="9" rowspan="3" style="font-family:Verdana; font-size:18px; font-weight:bold; color:#000000;">
			Алексей Колесников</td>
		<td>
			<img style="display:block;" src="http://ust-co.ru/podpiska/images/spacer.gif" width="1" height="2" alt=""></td>
	</tr>
	<tr>
...
<col style="width:218px;">
		...
		<tr>
		<td style="vertical-align:top;"><img style="display:block;" src="http://ust-co.ru/podpiska/images/news-primer.jpg" width="160" alt=""></td>
		<td></td>
		<td style="vertical-align:top; padding-top:20px;">
		<p style="font-family:Verdana; font-size:15px; color:#000000; font-weight:bold; position:relative; margin-top:-25px;">Приглашаем Вас посетить выставку «Металл-Экспо’2014»</p>
		...
		<p style="font-family:Verdana; font-size:13px; color:#000000;position:relative; margin-top:-10px;">Универсал-Спецтехника приглашает своих партнёров и клиентов посетить наш стенд на 20-й юбилейной Международной промышленной выставке «Металл-Экспо’2014».</p>
...
<col style="width:218px;">
	<tr>
		<td>
			<a href="#" style="font-size:13px; color:#8c8e92;">Посмотреть все Новости</a></td>
		<td></td>
		<td style="padding-left:18px;">
			<a href="#" style="font-size:13px; color:#8c8e92;">Посмотреть все Акции</a></td>
	</tr>
	</table>
