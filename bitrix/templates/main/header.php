...
//seo code
        if (preg_match("/\?/", $_SERVER['REQUEST_URI'])) {
            //ставим каноникал на все страницы с GET параметрами
            echo '<link rel="canonical" href="http://' . ($_SERVER["SERVER_NAME"]) . (preg_replace("/\?.*/", "", $_SERVER['REQUEST_URI'])) . '" />';
        }
        //ставим каноникал на пагинацию - старый вариант
...
//$APPLICATION->AddHeadScript('/design/js/jquery-1.10.2.min.js');
        ...
        $APPLICATION->AddHeadScript('/design/js/jquery-1.10.2.min.js');
        $APPLICATION->AddHeadScript('/design/js/jquery.session.js');
    ...
    <body>
        ...
        <div class="main-wrapper">
            ...
            <? if ($_SERVER["REQUEST_URI"] == "/"): ?>
                <div class="topnavmenu_bg">
                    <div class="topnavmenu">
                        <p class="topnavp str"><span></span><a href="http://u-st.ru/catalog/stroitelnaya-tekhnika/">Строительная техника</a></p>
                        <p class="topnavp ls"><span></span><a href="http://forestry.u-st.ru/catalog/lesozagotovitelnaya-tekhnika/">Лесотехника</a></p>
                        <p class="topnavp bso"><span></span><a href="http://burovoe-oborudovanie.u-st.ru/catalog/burovoe-i-svaeboynoe-oborudovanie/">Буровое и сваебойное оборудование</a></p>
                        <p class="topnavp dso"><span></span><a href="http://u-st.ru/catalog/drobilno-sortirovochnoe-oborudovanie/">Дробильно-сортировочное оборудование</a></p>
                        <p class="topnavp bo"><span></span><a href="http://bsu.ust-co.ru/catalog/betonnoe-oborudovanie/">Бетонное оборудование</a></p>
                        <p class="topnavp st"><span></span><a href="http://ust-co.ru/catalog/skladskaya-tekhnika/">Складская техника</a></p>
                        <p class="topnavp mk"><span></span><a href="http://u-st.ru/catalog/mobilnye-krany/">Мобильные краны</a></p>
                    </div>
                </div>
            <? endif; ?>

            <? if ($_SERVER["REQUEST_URI"] == "/happy-new-year/" || $_SERVER["REQUEST_URI"] == "/happy-new-year-en/"): ?><div class="page_happy"><? endif; ?>

                <div class="page-content<? if ($_SERVER["REQUEST_URI"] == "/" || $_SERVER["REQUEST_URI"] == "/happy-new-year/" || $_SERVER["REQUEST_URI"] == "/happy-new-year-en/" || $_SERVER["SCRIPT_NAME"] == "/index.php"): ?> main<? endif; ?>">
                    <? if ($_SERVER["REQUEST_URI"] != "/" && $_SERVER["REQUEST_URI"] != "/happy-new-year/" && $_SERVER["REQUEST_URI"] != "/happy-new-year-en/" && $_SERVER["SCRIPT_NAME"] != "/index.php"): ?>
                        <?
                        $content = "";
                        echo '<div class="wrapper">';
                        if ($APPLICATION->GetProperty("HIDE_MENU") != "Y" and strpos($_SERVER["REQUEST_URI"], "dilery") === false and strpos($_SERVER["REQUEST_URI"], "filialy") === false or http_response_code() == "404") {
